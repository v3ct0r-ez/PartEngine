...
| Attachments | ✅ | upload/list/download/delete (local FS storage); UI panel in the component editor (attach in both the new-component and edit windows). No text extraction / OCR / AI — the attach button only attaches the file. |
